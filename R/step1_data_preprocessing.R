...
##########################################################################################################################################
setwd("C:/Users/Dell/Dropbox/portfolio/r-server-hospital-length-of-stay/R/")
# Load packages. 
library(RevoScaleR)

# Load the connection string and compute context definitions.
#source("sql_connection.R")
source("C:/Users/Dell/Dropbox/portfolio/r-server-hospital-length-of-stay/R/sql_connection.R")
...
#file_path <- "../Data" 
file_path <- "C:/Users/Dell/Dropbox/portfolio/r-server-hospital-length-of-stay/Data"
