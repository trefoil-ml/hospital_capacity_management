...
##########################################################################################################################################
setwd("C:/Users/Gebruiker/Dropbox/portfolio/r-server-hospital-length-of-stay/R/")
...
source("C:/Users/Gebruiker/Dropbox/portfolio/r-server-hospital-length-of-stay/R/sql_connection.R")
...
#file_path <- "../Data" 
file_path <- "C:/Users/Gebruiker/Dropbox/portfolio/r-server-hospital-length-of-stay/Data"
...
# xdfSource <- RxXdfData(file = file.path(file_path, "LengthOfStay.csv"))
